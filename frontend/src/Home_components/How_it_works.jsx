      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-12 max-w-2xl mx-auto">
            Getting healthcare services has never been easier. Follow these
            simple steps to get started!
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12">
          <Link to="/login"><div className="w-full">
            <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl h-full">
              ...
              <p className="text-gray-600">
                Create an account with us to access all features of the app,
                including appointments, services, and more.
              </p>
            </div>
          </div>
</Link>
          <div className="w-full">
            <div className="p-6 bg-white rounded-lg shadow-lg hover:shadow-xl h-full">
              ...
              <p className="text-gray-600">
                Browse through available doctors, clinics, and services. Find
